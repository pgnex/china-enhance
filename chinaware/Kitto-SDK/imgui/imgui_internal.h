...
enum ImGuiButtonFlags_
{
	...
	ImGuiButtonFlags_Outlined = 1 << 14, // black outline around the box, road to skeet remake
	ImGuiButtonFlags_Gradient = 1 << 15 // A gradient instead of single color flat, colors adjusted in flags
};
